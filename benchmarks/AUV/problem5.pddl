...
(:domain AUV)
(:objects 
l-1-1 l-2-1 l-3-1 l-4-1 l-5-1 l-6-1 l-7-1 l-8-1 l-1-2 l-2-2 l-3-2 l-4-2 l-5-2 l-6-2 l-7-2 l-8-2 l-1-3 l-2-3 l-3-3 l-4-3 l-5-3 l-6-3 l-7-3 l-8-3 l-1-4 l-2-4 l-3-4 l-4-4 l-5-4 l-6-4 l-7-4 l-8-4 l-1-5 l-2-5 l-3-5 l-4-5 l-5-5 l-6-5 l-7-5 l-8-5 l-1-6 l-2-6 l-3-6 l-4-6 l-5-6 l-6-6 l-7-6 l-8-6 l-1-7 l-2-7 l-3-7 l-4-7 l-5-7 l-6-7 l-7-7 l-8-7 l-1-8 l-2-8 l-3-8 l-4-8 l-5-8 l-6-8 l-7-8 l-8-8 - location
...
(entry s2 l-3-1)
(exit s2 l-3-8)
(connected-ship s2 l-3-1 l-3-2)
(connected-ship s2 l-3-2 l-3-3)
(connected-ship s2 l-3-3 l-3-4)
(connected-ship s2 l-3-4 l-3-5)
(connected-ship s2 l-3-5 l-3-6)
(connected-ship s2 l-3-6 l-3-7)
(connected-ship s2 l-3-7 l-3-8)
(outside s2)
(entry s3 l-5-1)
(exit s3 l-5-8)
(connected-ship s3 l-5-1 l-5-2)
(connected-ship s3 l-5-2 l-5-3)
(connected-ship s3 l-5-3 l-5-4)
(connected-ship s3 l-5-4 l-5-5)
(connected-ship s3 l-5-5 l-5-6)
(connected-ship s3 l-5-6 l-5-7)
(connected-ship s3 l-5-7 l-5-8)
(outside s3)
(entry s4 l-7-8)
(exit s4 l-7-1)
(connected-ship s4 l-7-8 l-7-7)
(connected-ship s4 l-7-7 l-7-6)
(connected-ship s4 l-7-6 l-7-5)
(connected-ship s4 l-7-5 l-7-4)
(connected-ship s4 l-7-4 l-7-3)
(connected-ship s4 l-7-3 l-7-2)
(connected-ship s4 l-7-2 l-7-1)
(outside s4)
(entry s5 l-8-1)
(exit s5 l-8-8)
(connected-ship s5 l-8-1 l-8-2)
(connected-ship s5 l-8-2 l-8-3)
(connected-ship s5 l-8-3 l-8-4)
(connected-ship s5 l-8-4 l-8-5)
(connected-ship s5 l-8-5 l-8-6)
(connected-ship s5 l-8-6 l-8-7)
(connected-ship s5 l-8-7 l-8-8)
(outside s5)
(free l-2-1)
(free l-3-1)
(free l-4-1)
